...
#ifdef USE_MSQL
static int      msql_connect  (dbconn_t *, char *, char *, char *, char *);
static int      msql_close    (dbconn_t *);
static int      msql_execute  (dbconn_t *, char *);
...
#ifdef USE_MYSQL
static int      MySQL_connect  (dbconn_t *, char *, char *, char *, char *);
static int      MySQL_close    (dbconn_t *);
static int      MySQL_execute  (dbconn_t *, char *);
 ...
 */
static svalue_t *valid_database(char *  action, array_t *  info)
{
    svalue_t *ret;
...
static int MySQL_execute(dbconn_t *  c, char *  s)
{
...
static int MySQL_connect(dbconn_t *  c, char *  host, char *  database, char *  username, char * dbconn_t *0)
{
    int ret;
    MYSQL *tmp;
...
static int msql_execute(dbconn_t *  c, char *  s)
{
...
static int msql_connect(dbconn_t *  c, char *  host, char *  database, char *  username, char * dbconn_t *0)
{
