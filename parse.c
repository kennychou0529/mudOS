 ...
 */
static void
store_words_slice(svalue_t *  sp, int  pos, int  num, array_t *  warr, int svalue_t *0,svalue_t *1 svalue_t *2)
{
    svalue_t *ret;
    array_t *slice;
 ...
 */
static svalue_t *
       sub_parse(array_t *, obarr, array_t *  patarr, int *  pix_in, array_t *  warr, int *  cix_in, int * array_t *, obarr, array_t *0,array_t *, obarr, array_t *1 array_t *, obarr, array_t *2,array_t *, obarr, array_t *3 array_t *, obarr, array_t *4)
{
    int cix, pix, subfail;
    svalue_t *pval;
 ...
 */
static svalue_t *
one_parse(array_t *  obarr, char *  pat, array_t *  warr, int *  cix_in, int * array_t *0,array_t *1 array_t *2)
{
    char ch;
    svalue_t *pval;
    char *str1, *str2;
